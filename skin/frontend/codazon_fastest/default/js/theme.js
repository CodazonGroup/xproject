	...
	function cdzSlider(){
		$('.cdz-slider').each(function(){
			...
			$owl.owlCarousel({
				...
				dots: $owl.data('dots'),
				responsive:{
					0:{items: 	$owl.data('items-0')},
					320:{items:	$owl.data('items-320')},
					480:{items:	$owl.data('items-480')},
					768:{items:	$owl.data('items-768')},
					1024:{items: $owl.data('items-1024')},
					1280:{items: $owl.data('items-1280')}
				}	
			})
		});
	}
